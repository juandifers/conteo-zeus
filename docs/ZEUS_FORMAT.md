...
> and the posted balances were checked against the count sheet. §7.1 records the
...
> for. §10 is new: the golden file, what it locks and what it does not.
>
...
those balances were compared against the physical count sheet and agreed.
...
was uploaded into Zeus, Zeus posted the resulting balances, and those balances
were compared against the physical count sheet and agreed.
